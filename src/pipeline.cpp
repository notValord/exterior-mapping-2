...
GraphicsPipeline::GraphicsPipeline(const VkDevice device, const AttachementsFormats& imageFormats, const VkDescriptorSetLayout descriptorSL,
    ...
    graphicsPipeline = createGraphicsPipeline(descriptorSL, vertexFile, fragFile, pipelineLayout, renderPass);
}
...
void GraphicsPipeline::setupFrustumPipeline(const VkDescriptorSetLayout descriptorSL, const AttachementsFormats& imageFormats, const std::string& vertexFile, const std::string& fragFile) {
    ...
    frustumPipeline = createGraphicsPipeline(descriptorSL, vertexFile, fragFile, frustumPipelineLayout, onTopRenderPass);
}
...
void GraphicsPipeline::setupIntersectionPipeline(const VkDescriptorSetLayout descriptorSL, const AttachementsFormats& imageFormats, const std::string& vertexFile, const std::string& fragFile) {
    ...
    intersectionPipeline = createLinePipeline(descriptorSL, vertexFile, fragFile, intersectionPipelineLayout, onTopRenderPass);
}

VkPipeline GraphicsPipeline::createGraphicsPipeline(const VkDescriptorSetLayout descriptorSL, const std::string& vertexShader, const std::string& fragmentShader, 
    ...
    auto attributeDescription = Vertex::getAttribureDescriptions();
...
VkPipeline GraphicsPipeline::createLinePipeline(const VkDescriptorSetLayout descriptorSL, const std::string& vertexShader, const std::string& fragmentShader, 
    VkPipelineLayout& pipelineLayout, VkRenderPass& renderPass) {
    VkShaderModule vertShaderModule = createShaderModule(deviceHandle, vertexShader);
    VkShaderModule fragShaderModule = createShaderModule(deviceHandle, fragmentShader);
