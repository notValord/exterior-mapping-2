...
GraphicsPipeline::GraphicsPipeline(const VkDevice& device, const AttachementsFormats& imageFormats, const VkDescriptorSetLayout& descriptorSL,
    ...
    createGraphicsPipeline(descriptorSL);
}
...
void GraphicsPipeline::createGraphicsPipeline(const VkDescriptorSetLayout& descriptorSL) {
...
void GraphicsPipeline::createRenderPass(const AttachementsFormats& imageFormats) {
    VkAttachmentDescription colorAttachment{
        .format = imageFormats.swapChainImageFormat,
    ...
    VkSubpassDependency dependency {
        ...
        .dstAccessMask = VK_ACCESS_COLOR_ATTACHMENT_READ_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT,
    };
